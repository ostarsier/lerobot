...
class SO100Robot:
    def __init__(self, calibrate=False, enable_camera=False, camera_index=9):
        ...
        if not enable_camera:
            ...
            self.config.cameras = {"webcam": OpenCVCameraConfig(0, 30, 640, 480, "bgr"),
                                   "wrist_view": OpenCVCameraConfig(2, 30, 640, 480, "bgr")}
    ...
    def connect(self):
        ...
        self.camera2 = self.robot.cameras["wrist_view"] if self.enable_camera else None
    ...
    def get_current_img(self):
        ...
        img1 = self.get_observation()["observation.images.webcam"].data.numpy()
        img2 = self.get_observation()["observation.images.wrist_view"].data.numpy()
        # convert bgr to rgb
...
class Gr00tRobotInferenceClient:
    ...
    def get_action(self, img1, img2, state):
        obs_dict = {
            "video.webcam": img1[np.newaxis, :, :, :],
            "video.wrist_view": img2[np.newaxis, :, :, :],
...
if __name__ == "__main__":
    ...
    parser.add_argument("--actions_to_execute", type=int, default=350000000000)
